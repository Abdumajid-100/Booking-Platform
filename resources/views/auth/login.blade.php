...
<head>
    <meta charset="utf-8" />
    <title>Log In | Booking</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Sign in to the Booking Platform admin panel." />
                            ...
                            <div class="mb-0 p-0 p-lg-3">
                                <div class="mb-0 border-0 p-md-4 p-lg-0">
                                    ...
                                    <div class="auth-title-section mb-4 text-lg-start text-center">
                                        <h3 class="text-dark fw-semibold mb-3">Welcome back</h3>
                                        <p class="text-muted fs-14 mb-0">Sign in to manage bookings, schedules, and your platform data.</p>
                                    </div>

                                    <div class="row">
                                        <div class="col-6 mt-2">
                                            <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center" href="javascript:void(0)">
                                    ...
                                    <div class="pt-0">
                                        ...
                                        <form action="{{ route('login') }}" method="POST">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="email" name="email" id="emailaddress" value="{{ old('email') }}" required autocomplete="username" autofocus placeholder="Enter your email">
                                            </div>

                                            <div class="form-group mb-3">
                                                <label for="password" class="form-label">Password</label>
                                                <input class="form-control" name="password" type="password" required id="password" autocomplete="current-password" placeholder="Enter your password">
                                            </div>
